...
fetch('https://api.videoindexer.ai/Auth/trial/Accounts?generateAccessTokens=true&allowEdit=False',options).then(res => res.json())
   ...
   fetch('https://api.videoindexer.ai/trial/accounts/<<ACCOUNT_ID>>/videos/<<VIDEO_ID>>/Index?accessToken='+jsontoken[0].accessToken)
  .then((res) => { 
    return res.json() 
  })
  .then((jsonData) => {
...
var req = unirest("POST", "https://api.videoindexer.ai/trial/Accounts/<<ACCOUNT_ID>>/Videos");
...
fetch('https://api.videoindexer.ai/Auth/trial/Accounts?generateAccessTokens=true&allowEdit=True',options).then(res => res.json())
   ...
   console.log(jsontoken[0].accessToken);
    ...
    fetch('https://api.videoindexer.ai/trial/Accounts/<<ACCOUNT_ID>>/Videos?name=<<ACCOUNT_ID>>&privacy=Private&videoUrl='+encodeURIComponent(JSON.parse(res1.player_response).streamingData.formats[JSON.parse(res1.player_response).streamingData.formats.length-1].url)+'&indexingPreset=Default&streamingPreset=Default&sendSuccessEmail=False&accessToken='+jsontoken[0].accessToken,options1)
  .then((res) => { 
    return res.json(); 
  })
  .then((jsonData1) => {
...
res.send('<html>We are processing your request now. Click to check video insights. <body><a href="https://vidtrix.saurabhksinha90.repl.co/page3/?id='+JSON.parse(JSON.stringify(jsonData1)).id+'&main='+videoId+'"><input type="button" id="sub" value="Insights" /> </a> </body><html>');
...
fetch('https://api.videoindexer.ai/trial/Accounts/<<ACCOUNT_ID>>/Videos/'+videoId+'/Index?reTranslate=False&includeStreamingUrls=True&accessToken='+jsontoken[0].accessToken)
  .then((res) => { 
    return res.json() ;
  })
  .then((jsonData2) => {
...
if((jsonData2.state) ==='Processed') {
	...
	var data="<!DOCTYPE html><html lang='en'><head>    <meta charset='utf-8'>    <meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=no'>        <!-- SEO Meta Tags -->    <meta name='description' content='Create a stylish landing page for your business startup and get leads for the offered services with this HTML landing page template.'>    <meta name='author' content='VIDTRIX'>    <!-- OG Meta Tags to improve the way the post looks when you share the page on LinkedIn, Facebook, Google+ -->	<meta property='og:site_name' content='' /> <!-- website name -->	<meta property='og:site' content='' /> <!-- website link -->	<meta property='og:title' content=''/> <!-- title shown in the actual shared post -->	<meta property='og:description' content='' /> <!-- description shown in the actual shared post -->	<meta property='og:image' content='' /> <!-- image link, make sure it''s jpg --><meta property='og:url' content='' /> <!-- where do you want your post to link to -->	<meta property='og:type' content='article' />    <!-- Website Title -->    <title>VIDTRIX Video Analytics</title>        <!-- Styles -->  <link rel='stylesheet' href='https://use.fontawesome.com/releases/v5.0.8/css/all.css'>  <link href='https://fonts.googleapis.com/css?family=Raleway:400,400i,600,700,700i&amp;subset=latin-ext' rel='stylesheet'>    <link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/bootstrap.css' rel='stylesheet'>    <link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/fontawesome-all.css' rel='stylesheet'>    <link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/swiper.css' rel='stylesheet'>	<link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/magnific-popup.css' rel='stylesheet'>	<link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/styles.css' rel='stylesheet'>		<!-- Favicon  -->   <link rel='icon' href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/favicon1.png'></head><body data-spy='scroll' data-target='.fixed-top'>        <!-- Preloader -->	<div class='spinner-wrapper'>        <div class='spinner'>            <div class='bounce1'></div>            <div class='bounce2'></div>            <div class='bounce3'></div>        </div>    </div>    <!-- end of preloader -->       <!-- Navigation -->    <nav class='navbar navbar-expand-lg navbar-dark navbar-custom fixed-top'>        <!-- Text Logo - Use this if you don''t have a graphic logo -->        <!-- <a class='navbar-brand logo-text page-scroll' href='index.html'>VIDTRIX</a> -->        <!-- Image Logo -->        <a class='navbar-brand logo-image' href='https://vidtrix.saurabhksinha90.repl.co/check19'><img src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/Vidtrix_logo.png' alt='alternative' style='height:100px; width:110px;'></a>                <!-- Mobile Menu Toggle Button -->        <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarsExampleDefault' aria-controls='navbarsExampleDefault' aria-expanded='false' aria-label='Toggle navigation'>            <span class='navbar-toggler-awesome fas fa-bars'></span>            <span class='navbar-toggler-awesome fas fa-times'></span>        </button>        <!-- end of mobile menu toggle button -->       <div class='collapse navbar-collapse' id='navbarsExampleDefault'>            <ul class='navbar-nav ml-auto'>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/main_page'>Home <span class='sr-only'>(current)</span></a>                </li>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/main_page'>URL Based</a>                </li>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/upload_local'>File Upload</a>                </li>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/page3/?id=<<VIDEO_ID>>'>Already Uploaded</a>                </li>               <!-- Dropdown Menu -->                          <li class='nav-item dropdown'>                    <a class='nav-link dropdown-toggle page-scroll' href='#about' id='navbarDropdown' role='button' aria-haspopup='true' aria-expanded='false'>About</a>                    <div class='dropdown-menu' aria-labelledby='navbarDropdown'>                        <a class='dropdown-item' href='terms-conditions.html'><span class='item-text'>Terms Conditions</span></a>                        <div class='dropdown-items-divide-hr'></div>                        <a class='dropdown-item' href='privacy-policy.html'><span class='item-text'>Privacy Policy</span></a>                    </div>                </li>                <!-- end of dropdown menu -->                <li class='nav-item'>                    <a class='nav-link page-scroll' href='#contact'>Contact</a>                </li>            </ul>           <span class='nav-item social-icons'>                <span class='fa-stack'>                    <a href='#your-link'>                        <i class='fas fa-circle fa-stack-2x facebook'></i>                        <i class='fab fa-facebook-f fa-stack-1x'></i>                    </a>                </span>                <span class='fa-stack'>                    <a href='#your-link'>                        <i class='fas fa-circle fa-stack-2x twitter'></i>                        <i class='fab fa-twitter fa-stack-1x'></i>                    </a>                </span>            </span>        </div>   </nav> <!-- end of navbar -->    <!-- end of navigation -->    <!-- Header -->    <header id='header' class='header'>        <div class='header-content'>            <div class='container'>                <div class='row'>                    <div class='col-lg-6'>                        <div class='text-container'>                            <h1>VIDTRIX<span class='turquoise'> Video Analytics</span> Report</h1>                           <p class='p-large'>";                            
...
data=data+"   <!-- Footer -->    <div class='footer'>        <div class='container'>            <div class='row'>                <div class='col-md-4'>                    <div class='footer-col'>                        <h4>About VIDTRIX</h4>                        <p>We''re passionate about offering some of the best business growth services for startups</p>                    </div>                </div> <!-- end of col -->               <div class='col-md-4'>                    <div class='footer-col middle'>                        <h4>Important Links</h4>                        <ul class='list-unstyled li-space-lg'>                            <li class='media'>                                <i class='fas fa-square'></i>                                <div class='media-body'>Our business partners <a class='turquoise' href='#your-link'>startupguide.com</a></div>                            </li>                            <li class='media'>                                <i class='fas fa-square'></i>                                <div class='media-body'>Read our <a class='turquoise' href='terms-conditions.html'>Terms & Conditions</a>, <a class='turquoise' href='privacy-policy.html'>Privacy Policy</a></div>                            </li>                        </ul>                    </div>                </div> <!-- end of col -->               <div class='col-md-4'>                    <div class='footer-col last'>                        <h4>Social Media</h4>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-facebook-f fa-stack-1x'></i>                            </a>                        </span>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-twitter fa-stack-1x'></i>                            </a>                        </span>                       <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-google-plus-g fa-stack-1x'></i>                            </a>                        </span>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-instagram fa-stack-1x'></i>                            </a>                        </span>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                               <i class='fab fa-linkedin-in fa-stack-1x'></i>                            </a>                        </span>                    </div>                 </div> <!-- end of col -->            </div> <!-- end of row -->        </div> <!-- end of container -->    </div> <!-- end of footer -->      <!-- end of footer -->    <!-- Copyright -->    <div class='copyright'>        <div class='container'>            <div class='row'>               <div class='col-lg-12'>                    <p class='p-small'>Copyright Â© 2020 <a href='#'>VIDTRIX</a> - All rights reserved</p>                </div> <!-- end of col -->            </div> <!-- enf of row -->        </div> <!-- end of container -->    </div> <!-- end of copyright -->     <!-- end of copyright -->        	    <!-- Scripts -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/jquery.min.js'></script> <!-- jQuery for Bootstrap''s JavaScript plugins -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/popper.min.js'></script> <!-- Popper tooltip library for Bootstrap -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/bootstrap.min.js'></script> <!-- Bootstrap framework -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/jquery.easing.min.js'></script> <!-- jQuery Easing for smooth scrolling between anchors -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/swiper.min.js'></script> <!-- Swiper for image and text sliders -->   <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/jquery.magnific-popup.js'></script> <!-- Magnific Popup for lightboxes -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/validator.min.js'></script> <!-- Validator.js - Bootstrap plugin that validates forms -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/scripts.js'></script> <!-- Custom scripts --></body></html>";
  ...
  else
  {
  	...
  	res.send("Processing Progress ="+processingProgress+" Please try again in some time by clicking below button. "+"<body><a href='https://vidtrix.saurabhksinha90.repl.co/page3/?id="+videoId+"&main="+main.replace('https://www.youtube.com/watch?v=','')+"'><input type='button' id='sub' value='Insights' /> </a> </body><html>");
  }
  });
...
if((jsonData2.state) ==='Processed') {
	//res.send(jsonData2.state);
	var data="<!DOCTYPE html><html lang='en'><head>    <meta charset='utf-8'>    <meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=no'>        <!-- SEO Meta Tags -->    <meta name='description' content='Create a stylish landing page for your business startup and get leads for the offered services with this HTML landing page template.'>    <meta name='author' content='VIDTRIX'>    <!-- OG Meta Tags to improve the way the post looks when you share the page on LinkedIn, Facebook, Google+ -->	<meta property='og:site_name' content='' /> <!-- website name -->	<meta property='og:site' content='' /> <!-- website link -->	<meta property='og:title' content=''/> <!-- title shown in the actual shared post -->	<meta property='og:description' content='' /> <!-- description shown in the actual shared post -->	<meta property='og:image' content='' /> <!-- image link, make sure it''s jpg --><meta property='og:url' content='' /> <!-- where do you want your post to link to -->	<meta property='og:type' content='article' />    <!-- Website Title -->    <title>VIDTRIX Video Analytics</title>        <!-- Styles -->  <link rel='stylesheet' href='https://use.fontawesome.com/releases/v5.0.8/css/all.css'>  <link href='https://fonts.googleapis.com/css?family=Raleway:400,400i,600,700,700i&amp;subset=latin-ext' rel='stylesheet'>    <link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/bootstrap.css' rel='stylesheet'>    <link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/fontawesome-all.css' rel='stylesheet'>    <link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/swiper.css' rel='stylesheet'>	<link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/magnific-popup.css' rel='stylesheet'>	<link href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/styles.css' rel='stylesheet'>		<!-- Favicon  -->   <link rel='icon' href='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/favicon1.png'></head><body data-spy='scroll' data-target='.fixed-top'>        <!-- Preloader -->	<div class='spinner-wrapper'>        <div class='spinner'>            <div class='bounce1'></div>            <div class='bounce2'></div>            <div class='bounce3'></div>        </div>    </div>    <!-- end of preloader -->       <!-- Navigation -->    <nav class='navbar navbar-expand-lg navbar-dark navbar-custom fixed-top'>        <!-- Text Logo - Use this if you don''t have a graphic logo -->        <!-- <a class='navbar-brand logo-text page-scroll' href='index.html'>VIDTRIX</a> -->        <!-- Image Logo -->        <a class='navbar-brand logo-image' href='https://vidtrix.saurabhksinha90.repl.co/check19'><img src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/logo.jpg' alt='alternative'></a>                <!-- Mobile Menu Toggle Button -->        <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarsExampleDefault' aria-controls='navbarsExampleDefault' aria-expanded='false' aria-label='Toggle navigation'>            <span class='navbar-toggler-awesome fas fa-bars'></span>            <span class='navbar-toggler-awesome fas fa-times'></span>        </button>        <!-- end of mobile menu toggle button -->       <div class='collapse navbar-collapse' id='navbarsExampleDefault'>            <ul class='navbar-nav ml-auto'>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/main_page'>Home <span class='sr-only'>(current)</span></a>                </li>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/main_page'>URL Based</a>                </li>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/upload_local'>File Upload</a>                </li>                <li class='nav-item'>                    <a class='nav-link page-scroll' href='https://vidtrix.saurabhksinha90.repl.co/page3/?id=<<VIDEO_ID>>'>Already Uploaded</a>                </li>               <!-- Dropdown Menu -->                          <li class='nav-item dropdown'>                    <a class='nav-link dropdown-toggle page-scroll' href='#about' id='navbarDropdown' role='button' aria-haspopup='true' aria-expanded='false'>About</a>                    <div class='dropdown-menu' aria-labelledby='navbarDropdown'>                        <a class='dropdown-item' href='terms-conditions.html'><span class='item-text'>Terms Conditions</span></a>                        <div class='dropdown-items-divide-hr'></div>                        <a class='dropdown-item' href='privacy-policy.html'><span class='item-text'>Privacy Policy</span></a>                    </div>                </li>                <!-- end of dropdown menu -->                <li class='nav-item'>                    <a class='nav-link page-scroll' href='#contact'>Contact</a>                </li>            </ul>           <span class='nav-item social-icons'>                <span class='fa-stack'>                    <a href='#your-link'>                        <i class='fas fa-circle fa-stack-2x facebook'></i>                        <i class='fab fa-facebook-f fa-stack-1x'></i>                    </a>                </span>                <span class='fa-stack'>                    <a href='#your-link'>                        <i class='fas fa-circle fa-stack-2x twitter'></i>                        <i class='fab fa-twitter fa-stack-1x'></i>                    </a>                </span>            </span>        </div>   </nav> <!-- end of navbar -->    <!-- end of navigation -->    <!-- Header -->    <header id='header' class='header'>        <div class='header-content'>            <div class='container'>                <div class='row'>                    <div class='col-lg-6'>                        <div class='text-container'>                            <h1>VIDTRIX<span class='turquoise'> Video Analytics</span> Report</h1>                           <p class='p-large'>";                            
...
data=data+"   <!-- Footer -->    <div class='footer'>        <div class='container'>            <div class='row'>                <div class='col-md-4'>                    <div class='footer-col'>                        <h4>About Viewlytics</h4>                        <p>We''re passionate about offering some of the best business growth services for startups</p>                    </div>                </div> <!-- end of col -->               <div class='col-md-4'>                    <div class='footer-col middle'>                        <h4>Important Links</h4>                        <ul class='list-unstyled li-space-lg'>                            <li class='media'>                                <i class='fas fa-square'></i>                                <div class='media-body'>Our business partners <a class='turquoise' href='#your-link'>startupguide.com</a></div>                            </li>                            <li class='media'>                                <i class='fas fa-square'></i>                                <div class='media-body'>Read our <a class='turquoise' href='terms-conditions.html'>Terms & Conditions</a>, <a class='turquoise' href='privacy-policy.html'>Privacy Policy</a></div>                            </li>                        </ul>                    </div>                </div> <!-- end of col -->               <div class='col-md-4'>                    <div class='footer-col last'>                        <h4>Social Media</h4>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-facebook-f fa-stack-1x'></i>                            </a>                        </span>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-twitter fa-stack-1x'></i>                            </a>                        </span>                       <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-google-plus-g fa-stack-1x'></i>                            </a>                        </span>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                                <i class='fab fa-instagram fa-stack-1x'></i>                            </a>                        </span>                        <span class='fa-stack'>                            <a href='#your-link'>                                <i class='fas fa-circle fa-stack-2x'></i>                               <i class='fab fa-linkedin-in fa-stack-1x'></i>                            </a>                        </span>                    </div>                 </div> <!-- end of col -->            </div> <!-- end of row -->        </div> <!-- end of container -->    </div> <!-- end of footer -->      <!-- end of footer -->    <!-- Copyright -->    <div class='copyright'>        <div class='container'>            <div class='row'>               <div class='col-lg-12'>                    <p class='p-small'>Copyright Â© 2020 <a href='https://VIDTRIX.com'>VIDTRIX</a> - All rights reserved</p>                </div> <!-- end of col -->            </div> <!-- enf of row -->        </div> <!-- end of container -->    </div> <!-- end of copyright -->     <!-- end of copyright -->        	    <!-- Scripts -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/jquery.min.js'></script> <!-- jQuery for Bootstrap''s JavaScript plugins -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/popper.min.js'></script> <!-- Popper tooltip library for Bootstrap -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/bootstrap.min.js'></script> <!-- Bootstrap framework -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/jquery.easing.min.js'></script> <!-- jQuery Easing for smooth scrolling between anchors -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/swiper.min.js'></script> <!-- Swiper for image and text sliders -->   <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/jquery.magnific-popup.js'></script> <!-- Magnific Popup for lightboxes -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/validator.min.js'></script> <!-- Validator.js - Bootstrap plugin that validates forms -->    <script src='https://saurabhksinha.s3.jp-tok.cloud-object-storage.appdomain.cloud/scripts.js'></script> <!-- Custom scripts --></body></html>";
	res.send(data+"<br/><br/> <br/><br/><br/><br/><br/> <b>TRANSCRIPTS</b><br/><br/>"+text1);
...
fetch('https://www.googleapis.com/youtube/v3/search?key=<<KEY>>&channelId=<<CHANNEL_ID>>&part=snippet,id&order=date&maxResults=20',options).then(res => res.json())
    .then((jsonData) => {
...
fetch('https://api.videoindexer.ai/Auth/trial/Accounts?generateAccessTokens=true&allowEdit=False',options).then(res => res.json())
    .then((jsontoken) => {
   console.log(jsontoken[0].accessToken);
   fetch('https://api.videoindexer.ai/trial/Accounts/<<ACCOUNT_ID>>/Videos/<<VIDEO_ID>>/Index?reTranslate=False&includeStreamingUrls=True&accessToken='+jsontoken[0].accessToken)
  .then((res) => { 
    return res.json() 
  })
  .then((jsonData) => {
